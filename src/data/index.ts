...
export const AWARDS = [
  { title: "11 Dépôts Publics", cat: "GitHub"},

  { title: "Projets Variés", cat: "Web, Mobile, Backend" },
...
export const CONTACT_INFO = [
  { label: "Email", value: "rindra.leon@gmail.com" },

  { label: "GitHub", value: "github.com/rindraleon" },

  { label: "Localisation", value: "Madagascar" },

  { label: "Contact", value: "+261 34 29 340 64" },
]

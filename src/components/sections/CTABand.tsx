        ...
        >
          ...
          <div
            style={{
              ...
              height: 400,
              background:
                "radial-gradient(ellipse, rgba(0,85,255,0.1) 0%, transparent 70%)",
              filter: "blur(40px)",
              pointerEvents: "none",
            }}
          />
          <div style={{ position: "relative" }}>
            ...
            >
              Je suis disponible pour des projets de développement web et
              mobile. Si vous avez un projet en tête, discutons-en.
            </p>

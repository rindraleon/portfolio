        ...
        <Fade className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div>
            ...
            <h2 style={{ fontFamily: '"Playfair Display", serif', fontWeight: 700, fontSize: 'clamp(32px,4vw,48px)', letterSpacing: '-0.02em', lineHeight: 1.15, color: '#fff', marginTop: 16 }}>
              Le travail<br />est remarqué.
            </h2>
          </div>
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: 16, lineHeight: 1.6, color: '#a1a1aa', maxWidth: 360, textAlign: 'justify' }}>
            Onze prix de l'industrie en cinq ans. Nous sommes fiers de cette reconnaissance, mais plus fiers que les clients reviennent.
          </p>
        </Fade>
